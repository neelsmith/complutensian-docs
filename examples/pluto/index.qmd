...
### Browsing source material

- a IIIF viewer to [browse images](./imagebrowsing/)

###  Navigating the Madrid copy of the Complutensian

- [navigate by quire and page](./browse-codex/) to explore  the physical organization of each volume
- [navigate by *incipit/explicit* of Biblical books](./incipit/)

### The physical organization of the Complutensian 

- [table of contents](./toc/): index of texts to images
- [passages of text indexed to browsable image](./passage-plus-image/) 


## The Complutensian's editorial practices: alignment and orthography

- [Latin spacing markers](./spacing-markers-latin/)
- usage of [abbreviations in glosses](./abbreviations/) 

### Digital editing and indexing

- validating editing: [diplomatic text and indexing to source image](./validation/index.qmd)
- validating editing: [morphological validation of normalized text](./morphology-glosses/index.qmd)

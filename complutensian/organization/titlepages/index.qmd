...
In volumes 3 and 4, the title page begins the first quire listed in the register. It appears separately in an unlisted quire in volume 1 (quire `+`) and volume 5 (quire `a`), and as a single, separate sheet in volumes 2 and 6. In each volume, the title obviously must be the first page of the volume. 

...
The Greek New Testament is annotated with canonical references to other passages that should be consulted.

On volume 5, quire `A` page 1 verso, for example:
...
greekpsg = Cite2Urn("urn:cite2:citebne:complutensian.v1:v5a_p10@0.2000,0.1621,0.7720,0.05720")
xrefwgreek = linkedMarkdownImage(ict,greekpsg, imgservice; w = 600) 


latinpsg = Cite2Urn("urn:cite2:citebne:complutensian.v1:v5a_p10@0.6156,0.1624,0.3489,0.04459")
xrefwlatin = linkedMarkdownImage(ict,greekpsg, imgservice; w = 600) 


xrefwgreek * "\n\n"  * xrefwlatin |> Markdown.parse

```


Vol. 4 quire `b` page 1 verso, *Isaiah* 7:

urn:cite2:citebne:complutensian.v1:v4a_p14@0.4431,0.3222,0.5311,0.08328
